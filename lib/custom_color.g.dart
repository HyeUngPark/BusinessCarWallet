...
const customcolor1 = Color(0xFFA7DAF8);
const customcolor2 = Color(0xFFE5FFF8);


CustomColors lightCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFFA7DAF8),
  customcolor1: Color(0xFF006689),
  onCustomcolor1: Color(0xFFFFFFFF),
  customcolor1Container: Color(0xFFC2E8FF),
  onCustomcolor1Container: Color(0xFF001E2C),
  sourceCustomcolor2: Color(0xFFE5FFF8),
  customcolor2: Color(0xFF006B5E),
  onCustomcolor2: Color(0xFFFFFFFF),
  customcolor2Container: Color(0xFF75F8E2),
  onCustomcolor2Container: Color(0xFF00201B),
);

CustomColors darkCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFFA7DAF8),
  customcolor1: Color(0xFF77D1FF),
  onCustomcolor1: Color(0xFF003549),
  customcolor1Container: Color(0xFF004D68),
  onCustomcolor1Container: Color(0xFFC2E8FF),
  sourceCustomcolor2: Color(0xFFE5FFF8),
  customcolor2: Color(0xFF55DBC6),
  onCustomcolor2: Color(0xFF003730),
  customcolor2Container: Color(0xFF005047),
  onCustomcolor2Container: Color(0xFF75F8E2),
);
